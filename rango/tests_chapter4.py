...
class Chapter4TemplatesStructureTests(TestCase):
    ...
    def setUp(self):
        ...
        print ("Yabaa dabaa doo" + self.templates_dir )
...
class Chapter4ExerciseTests(TestCase):
    ...
    def test_about_contains_rango(self):
        ...
        """
        required_str = f"<img src=\"{settings.STATIC_URL}images/rango.jpg\" width=\"300\" height=\"300\" alt=\"Picture of Rango\" />"
        self.assertTrue(required_str in self.about_response.content.decode(),
    ...
    def test_about_contains_cat(self):
        ...
        """
        required_pattern = f"<img src=\"{settings.MEDIA_URL}cat.jpg\" width=\"300\" height=\"300\" alt=\"Picture of a Cat.?\" />"
